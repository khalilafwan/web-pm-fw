...
@section('title', 'PMElectric | Input Data Program')
        ...
        <div class="col-lg-6">
            ...
            <div class=" card mb-4 py-3">
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Masukkan PIC" name="program_pic" required>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="date-end ml-5 form-control datepicker col-sm-8"
                            placeholder="Masukan Waktu Start" name="program_start" required>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4 py-3">
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="date-end ml-5 form-control datepicker col-sm-8"
                            placeholder="Masukan Waktu End" name="program_end" required>
                    </div>
                </div>
            </div>
