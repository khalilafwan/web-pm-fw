...
<form method="POST"
    action="{{ route('dataMonitoring.update', ['dataMonitoring' => $dataMonitoring->id, 'formType' => 'nesting']) }}">
    @csrf
    @method('PUT')
        ...
        <div class="col-lg-6">
            ...
            <div class=" card mb-4 py-3">
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Masukkan PIC" name="program_pic">
                    </div>
                </div>
            </div>
