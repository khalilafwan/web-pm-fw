        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-4 py-3">
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="int" class="form-control" placeholder="Masukkan No" name="id">
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4 py-3">
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Masukkan No RPB" name="no_rpb">
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4 py-3">
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Masukkan No PO" name="no_po">
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-4 py-3">
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Masukkan Konsesi" name="konsesi">
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4 py-3">
                <div class="card-body">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="Masukkan No LKPJ" name="no_lkpj">
                    </div>
                </div>
            </div>
